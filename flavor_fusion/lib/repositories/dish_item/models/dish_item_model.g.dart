...
part of 'dish_item_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class DishItemModelAdapter extends TypeAdapter<DishItemModel> {
  @override
  final int typeId = 2;

  @override
  DishItemModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, DishItemModel obj) {
    writer
      ..writeByte(9)
      ..writeByte(0)
      ..write(obj.name)
