...
class ResultFoodTile extends StatefulWidget {
  final double width;
  final double height;
  final String time;
  final String name;
  ...
  @override
  State<ResultFoodTile> createState() => _ResultFoodTileState();
}

class _ResultFoodTileState extends State<ResultFoodTile> {
  @override
                                  ...
                                  Align(
                                    ...
                                    child: Image.network(
                                      !inFavorites
                                          ...
                                          : "https://cdn-icons-png.flaticon.com/512/5644/5644698.png",
